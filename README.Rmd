...
Launch the [`make.R`](https://github.com/LornaUrquieta/proyecto/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/LornaUrquieta/proyecto/blob/main/CONTRIBUTING.md).
